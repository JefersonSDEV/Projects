...
menubtn.onclick = function (e) {
  e.preventDefault();
  menu.classList.toggle("menuConfig");
};
...
/*CONFIGURAÇÕES WEB*/
const $dropWeb = document.querySelector(".login");
const $ConfigWeb = document.querySelector(".links");

$dropWeb.onclick = function (e) {
  e.preventDefault();
  $ConfigWeb.classList.toggle("menuConfig");
};

/*CONFIGURAÇÕES DROP SERVICES/PRODUCTS*/
const dropd = document.querySelector(".drop-desc");
const Configure = document.querySelector(".desc-info-prod p");

dropd.onclick = function (e) {
  e.preventDefault();
  Configure.classList.toggle("drop-prods");
